...
<head>
    ...
    <?php wp_head(); ?>
    <!-- Google Analytics 4（GA4，唯一分析源；已移除重複的 GTM）-->
    ...
    (function(){
        ...
        function loadDeferred(){
            ...
            fbq('init', '1386137638735275');
            fbq('track', 'PageView');

            // LINE Tag
            (function(g,d,o){g._ltq=g._ltq||[];g._lt=g._lt||function(){g._ltq.push(arguments)};var h=location.protocol==='https:'?'https://d.line-scdn.net':'http://d.line-cdn.net';var s=d.createElement('script');s.async=1;s.src=o||h+'/n/line_tag/public/release/v1/lt.js';var t=d.getElementsByTagName('script')[0];t.parentNode.insertBefore(s,t);})(window, document);
            _lt('init', {customerType: 'lap', tagId: '299420f4-b7ee-4f96-b243-c4fa8c70f23f'});
            _lt('send', 'pv', ['299420f4-b7ee-4f96-b243-c4fa8c70f23f']);

            // AdSense（保留、之後會用；先延後載避免阻塞 LCP）
            var ad = document.createElement('script');
            ad.async = true;
            ad.src = 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2150625846941263';
